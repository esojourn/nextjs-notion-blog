---
title: 'Windows 11中，使用中转API配置Claude Code'
date: '2025-10-03'
lastmod: '2026-03-24'
tags: ['中转站', 'Anthropic', 'Claude Code']
draft: false
summary: '本文档提供适用于 Windows 11中，配置Anthropic Claude Code程序的操作。使用中转API，免去各种人为设置的障碍，帮助快捷完成配置工作。'
...
![PowerShell](/static/images/251003-01.jpeg)
2. **配置信息确认**
...
![MCP](/static/images/251003-02.jpeg)

原来截图里使用模型简称sonnet45或opus45。现在API已经调整，模型名称和官方统一，不再需要使用简称形式
